  ...
  [252],
  {
    47252: function (n, e, r) {
      ...
      (n = r.nmd(n)),
          ...
          return (function (n) {
            ...
            return (
              ...
              (r.t = function (n, e) {
                ...
                if (4 & e && "object" == a(n) && n && n.__esModule) return n;
            ...
            function (n, e, r) {
              ...
              function d(n) {
                return void 0 === n && (n = window), n.location.protocol === u;
              }
              function l(n) {
                if (n)
                  try {
              ...
              var I = (function () {
                function n(n) {
                  ...
                  if (
                    ...
                    D(), (u = !0), o ? this.resolve(r) : i && this.reject(t);
                  }
                }
                var e = n.prototype;
                return (
                          ...
                          e.errorHandled ||
                            (function (n, e) {
                              if (-1 === O.indexOf(n)) {
                                ...
                                for (var r = 0; r < P.length; r++) P[r](n, e);
                              }
                            })(n, e);
                        }, 1),
                      this.dispatch(),
                  ...
                  (n.all = function (e) {
                    ...
                    for (
                      var i = function (i) {
                          ...
                          if (u instanceof n) {
                            if (u.resolved)
                              return (o[i] = u.value), (t -= 1), "continue";
                          } else if (!j(u))
                            return (o[i] = u), (t -= 1), "continue";
                          n.resolve(u).then(
                            function (n) {
                              (o[i] = n), 0 == (t -= 1) && r.resolve(o);
                            },
                            function (n) {
                              r.reject(n);
                            },
                ...
                q = (function () {
                  ...
                  return (
                    ...
                    (e.has = function (n) {
                      ...
                      return (
                        this._cleanupClosedWindows(), -1 !== C(this.keys, n)
                      );
                    }),
              ...
              function H(n) {
                ...
                function r() {
                  ...
                  return (
                    e.hasOwnProperty(i) ||
                      (e[i] = n.apply(this, arguments).finally(function () {
                        delete e[i];
                      })),
                    e[i]
                  );
              ...
              function B(n, e) {
                ...
                try {
                  ...
                  return "function" == typeof n.toString
                    ? n.toString()
                    : {}.toString.call(n);
                } catch (n) {
              ...
              var Z = "postrobot_method",
                G = "postrobot_hello",
                Q = "*",
                V = "cross_domain_zalgo_promise",
                X = "cross_domain_function",
                $ = "cross_domain_window";
              function nn(n) {
                return (
                  void 0 === n && (n = window),
                  n !== window
                    ? n.__post_robot_10_0_14__
                    : (n.__post_robot_10_0_14__ =
                        n.__post_robot_10_0_14__ || {})
                );
              }
              ...
              function on() {
                var n = nn();
                return (
                  (n.WINDOW_WILDCARD = n.WINDOW_WILDCARD || new tn()),
                  n.WINDOW_WILDCARD
                );
              }
              function un(n, e) {
                return (
                  void 0 === n && (n = "store"),
                  void 0 === e && (e = en),
                  rn("windowStore").getOrSet(n, function () {
                    var r = new q(),
                      t = function (n) {
              ...
              function an() {
                return rn("instance").getOrSet("instanceID", F);
              }
              function cn(n) {
              ...
              function sn(n, e) {
                return (0, e.send)(
                  ...
                  var r = e.origin,
                    t = e.data.instanceID;
                  return (
                    cn(n).resolve({ win: n, domain: r }),
                    { win: n, domain: r, instanceID: t }
                  );
                });
              }
              function fn(n, e) {
                ...
                return un("windowInstanceIDPromises").getOrSet(n, function () {
                  return sn(n, { send: r }).then(function (n) {
                    return n.instanceID;
                  });
                });
              }
              ...
              var On,
                Pn =
                  ...
                  (ln[vn] = function () {}),
                  (ln[pn] = function (n) {
                    return Sn(pn, n.source);
                  }),
                  (ln[mn] = function (n) {
                    return Sn(mn, n.toJSON());
                  }),
                  (ln[yn] = function (n) {
                    return n;
                  }),
              ...
              function Dn() {
                for (
                  var n = rn("idToProxyWindow"), e = 0, r = n.keys();
                  e < r.length;
                  e++
                ) {
                  var t = r[e];
                  ...
                  setName: function (n) {
                    return I.try(function () {
                      ((e = (function (n) {
                        ...
                        e.frameElement &&
                          e.frameElement.setAttribute("name", n),
                        (t = n);
                    });
                  },
                };
                ...
                return (
                  ...
                  (e.focus = function () {
                    ...
                    return I.try(function () {
                      return I.all([
                        n.isPopup() &&
                          n.serializedWindow.getName().then(function (n) {
                            n && window.open("", n);
                          }),
                  ...
                  (e.setWindow = function (n) {
                    (this.actualWindow = n),
                      (this.serializedWindow = In(this.serializedWindow.id, n, {
                        send: this.send,
                      })),
                  ...
                  (n.serialize = function (e, r) {
                    var t = r.send;
                    return Dn(), n.toProxyWindow(e, { send: t }).serialize();
                  }),
                  (n.deserialize = function (e, r) {
                    ...
                    return (
                      Dn(),
                      rn("idToProxyWindow").getOrSet(e.id, function () {
                        return new n(e, null, { on: t, send: o });
                      })
                    );
                  }),
                  (n.isProxyWindow = function (n) {
                    return Boolean(n && !k(n) && n.isProxyWindow);
                  }),
                  (n.toProxyWindow = function (e, r) {
                    var t = r.send;
                    if ((Dn(), n.isProxyWindow(e))) return e;
                    var o = e;
                    return un("winToProxyWindow").getOrSet(e, function () {
                      var e = F(),
                        r = new n(In(e, o, { send: t }), o, { send: t });
                      return rn("idToProxyWindow").set(e, r);
                    });
                  }),
                  n
                );
              })();
              function Cn(n, e, r, t, o) {
                var i = un("methodStore"),
                  u = rn("proxyWindowMethods");
                Rn.isProxyWindow(t)
                  ? u.set(n, { val: e, name: r, domain: o, source: t })
                  : (u.del(n),
              ...
              function Tn(n, e) {
                var r = un("methodStore"),
                  t = rn("proxyWindowMethods");
                return (
              ...
              function Nn(n, e, r, t, o) {
                var i;
                (i = o.on),
                  rn("builtinListeners").getOrSet("functionCalls", function () {
                    return i(Z, { domain: Q }, function (n) {
                      var e = n.source,
                        r = n.origin,
                        t = n.data,
                        o = t.id,
                      ...
                      return I.try(function () {
                        if (!x(c, r))
                          throw new Error(
                            "Method '" +
                              ...
                              "' domain " +
                              JSON.stringify(
                                K(u.domain) ? u.domain.source : u.domain,
                              ) +
                        ...
                        if (Rn.isProxyWindow(a))
                          return a.matchWindow(e).then(function (n) {
                            if (!n)
                              throw new Error(
                                "Method call '" +
                                  t.name +
              ...
              function Ln(n, e, r, t) {
                ...
                return (function (n, e) {
                  ...
                  (o[hn] = function (r, t) {
                    return Nn(n, e, r, t, { on: i, send: u });
                  }),
                  (o[gn] = function (n) {
                    return k(n) || Rn.isProxyWindow(n)
                      ? Sn($, Rn.serialize(n, { send: u }))
                      : n;
                  }),
                  o),
                );
                    ...
                    return (function (n, e, t, o) {
                      var i = r.id,
                        ...
                        c = function (r) {
                          function t() {
                            var o = arguments;
                            return Rn.toProxyWindow(n, { send: a })
                              .awaitWindow()
                              .then(function (n) {
                                var c = Tn(n, i);
                                if (c && c.val !== t)
                        ...
                        s = c();
                      return (s.fireAndForget = c({ fireAndForget: !0 })), s;
                    })(n, e, 0, { on: i, send: u });
                  }),
                  (o[$] = function (n) {
                    return Rn.deserialize(n, {
                      on: (e = { on: i, send: u }).on,
                      send: e.send,
                    });
                    var e;
              ...
              function Hn(n, e, r, t) {
                ...
                for (
                  var a = Ln(
                      n,
                      e,
                      (((o = {}).__post_robot_10_0_14__ = R(
                        { id: F(), origin: p(window) },
                        r,
                      )),
                      o),
                      { on: i, send: u },
              ...
              Fn.postrobot_post_message = function (n, e, r) {
                (Array.isArray(r) ? r : "string" == typeof r ? [r] : [Q])
                  .map(function (n) {
                    return 0 === n.indexOf(i) ? Q : n;
                  })
                  .forEach(function (r) {
                    n.postMessage(e, r);
                  });
              ...
              var Jn,
                Bn = "__domain_regex__";
              function Un(n) {
                return rn("responseListeners").get(n);
              }
              function Kn(n) {
                rn("responseListeners").del(n);
              }
              function Yn(n) {
                return rn("erroredResponseListeners").has(n);
              }
              function Zn(n) {
                var e = n.name,
                  r = n.win,
                ...
                if ((r === Q && (r = null), t === Q && (t = null), !e))
                  throw new Error("Name required to get request listener");
                for (var i = 0, u = [r, on()]; i < u.length; i++) {
                  var a = u[i];
                  if (a) {
                    var c = o.get(a);
                    if (c) {
                      ...
                      if (s) {
                        if (t && "string" == typeof t) {
                          if (s[t]) return s[t];
                          if (s[Bn])
                            for (var f = 0, d = s[Bn]; f < d.length; f++) {
                              var l = d[f],
                                h = l.listener;
                              if (x(l.regex, t)) return h;
                            }
                        }
                        if (s[Q]) return s[Q];
                      }
              ...
              var Gn =
                (((Jn = {}).postrobot_message_request = function (n, e, r, t) {
                  var o = t.on,
                    i = t.send,
                    u = Zn({ name: r.name, win: n, domain: e });
                  function a(t, u, a) {
                    void 0 === a && (a = {}),
                      r.fireAndForget ||
                        b(n) ||
                        Hn(
                          n,
                          e,
                          R({ type: t, ack: u, hash: r.hash, name: r.name }, a),
                          { on: o, send: i },
                        );
                  }
                  return I.all([
                    a("postrobot_message_ack"),
                    I.try(function () {
                      if (!u)
                        throw new Error(
                      ...
                      return u.handler({ source: n, origin: e, data: r.data });
                    }).then(
                      function (n) {
                ...
                (Jn.postrobot_message_ack = function (n, e, r) {
                  if (!Yn(r.hash)) {
                    var t = Un(r.hash);
                    if (!t)
                      throw new Error(
                ...
                (Jn.postrobot_message_response = function (n, e, r) {
                  if (!Yn(r.hash)) {
                    var t,
                      i = Un(r.hash);
                    if (!i)
                ...
                var u = n.source,
                  ...
                  s = (function (n, e, r, t) {
                    ...
                    if (
                      ...
                      return o;
                  })(n.data, u, c, { on: r, send: t });
                s &&
                  (dn(u),
                  o.has(s.id) ||
                    (o.set(s.id, !0),
                    (b(u) && !s.fireAndForget) ||
                      (0 === s.origin.indexOf(i) && (c = i + "//"),
                      Gn[s.type](u, c, s, { on: r, send: t }))));
              }
              function Vn(n, e, r) {
                  ...
                  i = (function n(e, r) {
                    ...
                    if (Array.isArray(o)) {
                      for (var a = [], c = 0, s = o; c < s.length; c++)
                        a.push(n({ name: t, domain: i, win: s[c] }, r));
                      return {
                        cancel: function () {
                    ...
                    if (Array.isArray(i)) {
                      for (var f = [], d = 0, l = i; d < l.length; d++)
                        f.push(n({ name: t, win: o, domain: l[d] }, r));
                      return {
                        cancel: function () {
                    ...
                    var h = Zn({ name: t, win: o, domain: i });
                    if (((o && o !== Q) || (o = on()), (i = i || Q), h))
                      throw o && i
                        ? new Error(
                        ...
                        : o
                          ...
                          : i
                            ...
                            : new Error(
                                "Request listener already exists for " + t,
                              );
                    var w,
                      v,
                      p = u.getOrSet(o, function () {
                        return {};
                      }),
                      m = Y(p, t, function () {
                        return {};
                        ...
                        cancel: function () {
                          delete m[y],
                            v &&
                              ...
                              w.length || delete m[Bn]),
                            Object.keys(m).length || delete p[t],
                            o && !Object.keys(p).length && u.del(o);
                        },
                      }
                    );
                  })(
                ...
                return I.try(function () {
                  return (
                    (function (n, e, r) {
                      ...
                      if (b(e)) throw new Error("Target window is closed");
                    })(r, e, i),
                    (function (n, e, r, t) {
                      var o = t.send;
                      return I.try(function () {
                          ...
                          if (
                            (function (n) {
                              if (n) {
                                ...
                                if (l(n) === n) return n;
                                try {
                                  if (y(window, n) && window.top)
                                    return window.top;
                                } catch (n) {}
                                try {
                                  if (y(n, window) && window.top)
                                    return window.top;
                                } catch (n) {}
                                for (
                                  var e = 0,
                            ...
                            return !1;
                          for (var t = 0, o = g(n); t < o.length; t++)
                            if (o[t] === e) return !0;
                          return !1;
                        })(window, n)
                          ? (function (n, e, r) {
                  ...
                  if (!x(i, o))
                    throw new Error(
                      "Domain " + U(i) + " does not match " + U(o),
                    );
                  i = o;
                  var a,
                    s,
                    f =
                      r === Z && t && "string" == typeof t.name
                        ? t.name + "()"
                        : r,
                    d = new I(),
                    l = r + "_" + F();
                  if (!c) {
                    var h = { name: r, win: e, domain: i, promise: d };
                    !(function (n, e) {
                      rn("responseListeners").set(n, e);
                    })(l, h);
                    var w = un("requestPromises").getOrSet(e, function () {
                      return [];
                    });
                    w.push(d),
                      d.catch(function () {
                        !(function (n) {
                          rn("erroredResponseListeners").set(n, !0);
                        })(l),
                          Kn(l);
                      });
                    var v = (function (n) {
              ...
              function ne(n, e, r) {
                return Ln(n, e, r, { on: Vn, send: $n });
              }
              function ee(n, e, r) {
                return qn(n, e, r, { on: Vn, send: $n });
              }
              function re(n) {
                return Rn.toProxyWindow(n, { send: $n });
              }
              function te() {
                var n, e, r, t;
                nn().initialized ||
                  ...
                  ((t = nn()).receiveMessage =
                    t.receiveMessage ||
                    function (n) {
                      return Qn(n, { on: e, send: r });
                    }),
                  (function (n) {
                    var e = n.on,
                      r = n.send;
                    rn().getOrSet("postMessageListener", function () {
                      return (
                  ...
                  (function (n) {
                    var e = n.on,
                      r = n.send;
                    rn("builtinListeners").getOrSet(
                      "helloListener",
                      function () {
                        var n = e(G, { domain: Q }, function (n) {
                            var e = n.source,
                              r = n.origin;
                            return (
                              cn(e).resolve({ win: e, domain: r }),
                              { instanceID: an() }
                            );
                          }),
                          t = E();
                        return t && sn(t, { send: r }).catch(J), n;
                      },
                    );
                  })({ on: Vn, send: $n }));
              }
              function oe() {
                ...
                !(function () {
                  for (
                    var n = rn("responseListeners"), e = 0, r = n.keys();
                    e < r.length;
                    e++
                  ) {
                    var t = r[e],
                  ...
                  (n = rn().get("postMessageListener")) && n.cancel(),
                  delete window.__post_robot_10_0_14__;
              }
              function ie(n) {
                for (
                  var e = 0, r = un("requestPromises").get(n, []);
                  e < r.length;
                  e++
                )
                  r[e]
        ...
        "object" == a(e) && "object" == a(n)
          ? (n.exports = u())
          : ((o = []),
            void 0 === (i = "function" == typeof (t = u) ? t.apply(e, o) : t) ||
              (n.exports = i));
    },
  },
]);

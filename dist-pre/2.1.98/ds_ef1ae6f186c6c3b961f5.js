/*! For license information please see ds_ef1ae6f186c6c3b961f5.js.LICENSE.txt */
!(function (e, t) {
  ...
  (() => {
    var e,
      t = {
        6776: (e, t, n) => {
          ...
          n.r(t);
          var i = n(47584),
            o = (n(85990), new (n(33491).A)());
          jQuery(function (e) {
            e.widget("thiss.discovery_client", {
              options: {
                persistence: void 0,
                search: void 0,
                mdq: void 0,
              ...
              _create: function () {
                var t = this;
                ((t.ac = []),
                  e.isFunction(t.options.render) || (t.options.render = e.noop),
                  e.isFunction(t.options.search) ||
                    ((t.options.search_url = t.options.search),
                    (t.options.search = function (e, n) {
                      t.ac.forEach(function (e) {
                        return e.abort();
                      });
                      ...
                      (t.ac.push(o),
                        (0, i.pe)(
                          e,
                          t.options.search_url,
                          t.options.entityID,
                          t.options.trustProfile,
                          { signal: o.signal },
                        )
                          .then(function (e) {
                            return e.filter(function (e) {
                              return "true" !== e.hidden;
                            });
                          })
                          .then(function (e) {
                            (t.ac.shift(), o.signal.aborted || n(e));
                          })
                          .catch(function (e) {
                            console.log("ERROR creating widget:", e);
                          }));
                    })),
                  e.isFunction(t.options.render_search_result) ||
                    (t.options.render_search_result = t.options.render),
                  e.isFunction(t.options.render_saved_choice) ||
                    (t.options.render_saved_choice = t.options.render),
                  e.isFunction(t.options.fallback_icon) ||
                    (t.options.fallback_icon = e.noop),
                  e.isFunction(t.options.after) || (t.options.after = e.noop),
                  e.isFunction(t.options.before) ||
                    (t.options.before = function (e) {
                      return e;
                    }),
                  e.isFunction(t.options.persist) ||
                    (t.options.persist = function () {
                      return !0;
                    }),
                  t._update());
              },
              _setOption: function (e, t) {
                ((this.options[e] = t), this._update());
              },
              sp: function () {
                ...
                return e
                  ? this._ds.mdq_sp(e).then(function (t) {
                      return t
                        ? Promise.resolve(t)
                        : Promise.resolve({ entity_id: e, title: e });
                    })
                  : (console.log(
              ...
              _after: function (t) {
                var n = e(this.options.saved_choices_selector);
                if (this.options.search) {
                  var i = this,
                    r = e(i.options.search_result_selector),
                    s = 0;
                  (e(i.options.input_field_selector).focus(),
                    r.btsListFilter(i.options.input_field_selector, {
                      localization: o,
                      resetOnBlur: !1,
                      casesensitive: !1,
                      maxResults: 10,
                      minLength: "${MIN_SEARCH_LENGTH}",
                      itemEl: i.options.entity_selector,
                      getValue: function (e) {
                        var t = e.val(),
                          n = t.indexOf("@");
                        return n > -1 ? t.substring(n + 1, t.length) : t;
                      },
                      sourceNodes: function (t, n, o, r) {
                        if (o && 0 !== o.length)
                          if (t.maxResults > 0 && o.length > t.maxResults)
                            r(i.options.too_many_results(this, o.length));
                          else {
                            var a = 0,
                              l = function (e) {
                                var t = (function () {
                                    if (0 === a)
                                      return (
                                        (a = o.length < 25 ? o.length : 25),
                                        o.slice(0, 24)
                                      );
                                    if (o.length >= 25) {
                                      var e = o.slice(a, a + 25);
                                      return ((a += e.length), e);
                                    }
                                  })(),
                                  n = [];
                                for (var l in (e && (s = 0), t)) {
                                  var c = t[l];
                                  ((s += 1),
                                    (c.counter = s),
                                    (c.saved = !1),
                                ...
                                r(i.options.render_search_result(t));
                              };
                            (l(!0),
                              (window.onscroll = function (t) {
                                o.length >= 25 &&
                                  e(window).scrollTop() + e(window).height() >
                                    0.75 * e(document).height() &&
                                  l(!1);
                              }));
                          }
                        else r(i.options.no_results(n));
                      },
                      sourceData: i.options.search,
                      cancelNode: function () {
                        console.log("cancel");
                      },
                    }));
                }
                this.options.after(t, n);
              },
              _update: function () {
                var t = this;
                ((t._ds = new i.KC(
                  ...
                  t.options.context,
                  {
                    entityID: t.options.entityID,
                    trustProfile: t.options.trustProfile,
                  },
                )),
                  (t._count = 0),
                  t.element,
                  e("img.pyff-idp-icon").bind("error", function () {
                    (e(this).unbind("error"), t.options.fallback_icon(this));
                  }),
                  e("body").on(
                    "mouseenter",
                    t.options.entity_selector,
                    function (t) {
                  ...
                  e("body").on(
                    ...
                    function (n) {
                      n.preventDefault();
                      var i = e(this)
                        .closest(t.options.entity_selector)
                        .attr("data-href");
                      return t._ds.saml_discovery_response(
                        i,
                        t.options.persist(),
                      );
                    },
                  ...
                  e("body").on(
                    ...
                    t.options.entity_selector,
                    function (t) {
                      13 === t.keyCode && (t.preventDefault(), e(this).click());
                    },
                  ),
                  e(t.options.input_field_selector)
                    .closest("form")
                    .submit(function (e) {
                      e.preventDefault();
                    }),
                  e("body").on(
                    ...
                    function (n) {
                      ...
                      var i = e(this).closest(t.options.entity_selector),
                        o = e(this).closest("li.list-item");
                      t._count = i.siblings().length + 1;
                  ...
                  e("body").on("keypress", ".remove", function (t) {
                    13 == t.which && e(".remove").click();
                  }),
                  t._ds.with_items(function (e) {
                    return t.options
                      .before(e)
                      .then(function (e) {
                        var n = 0,
                        ...
                        return (
                          e &&
                            ...
                            e.forEach(function (e) {
                              var t = e.entity;
                              ((t.saved = !0), i.push(t), n++);
                            }),
                          t.options.render_saved_choice(i),
                          n
                        );
                      })
                      .then(function (n) {
        ...
        33491: (e, t, n) => {
          ...
          var v = n(87860),
            m = "en",
            g = document.getElementById("locale-selector"),
            y = (function (e) {
              function t(e) {
                var n;
                return (
                ...
                (s = [
                  {
                    ...
                    value: function (e) {
                      if (
                        "title_langs" in e &&
                        e.title_langs &&
                        e.title_langs.constructor === Object
                      )
                        for (
                          var t = 0, n = Object.keys(e.title_langs);
                          t < n.length;
                          t++
                        ) {
                          var i = n[t];
                          (i in this.dynamic || (this.dynamic[i] = {}),
                            (this.dynamic[i][e.entityID] = e.title_langs[i]));
                        }
                    },
                  },
                  {
                    ...
                    value: function () {
                      ...
                      g &&
                        g.addEventListener("change", function (t) {
                          ((e.locale = t.target.value),
                            e.updateLocaleSelector(t.target.value),
                            e.selectAvailableLocale());
                        });
                    },
                  },
                  {
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      return new Promise(function (n, i) {
                        fetch("/translations/".concat(e, ".json"))
                          .then(function (e) {
                            return e.json();
                          })
                          .then(function (i) {
                            if (e in t.dynamic)
                              for (
                                var o = 0, r = Object.keys(t.dynamic[e]);
                                o < r.length;
                                o++
                              ) {
                                var s = r[o];
                            ...
                            for (
                              ...
                              var c = a[l].dataset.i18n;
                              if (c) {
                                var u = t.i18n(c);
                                u && u !== c && (a[l].textContent = u);
                              }
                            }
                            n();
                          })
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      var t = this.i18n(e);
                      return this.file.hasOwnProperty(t)
                        ? this.file[t]
                          ? this.file[t]
                          : ""
                        : t;
                            ...
                            for (;;)
                              switch (e.n) {
                                case 0:
                                  ...
                                  ((n = this.translateString(t)), (e.n = 9));
                                  break;
                                case 1:
                                  ((i = !1),
                                    (s = a(new Array(60).keys())),
                                    (e.p = 2),
                                    (c = r().m(function e() {
        ...
        52890: () => {
          var e;
          (e = jQuery).fn.btsListFilter = function (t, n) {
            "use strict";
            var i,
              o,
              r,
            ...
            return (
              (n = e.extend(
                {
                  ...
                  emptyNode: function (e) {
                    var t = f.translateString("list-filter-no-results");
                  ...
                  maxResults: -1,
                  maxResultsNode: function (e) {
                    var t = f.translateString("list-filter-too-many-results");
                  ...
                  itemChild: null,
                  itemFilter: function (t, i) {
                    i = i && i.replace(new RegExp("[({[^.$*+?\\]})]", "g"), "");
                    var o = e(t).text(),
                      r = n.initial ? "^" : "";
                    return new RegExp(r + i, n.casesensitive ? "" : "i").test(
                      o,
                    );
                  },
                  showEvent: "show.bs",
              ...
              e("body").on("click", "#reset", function () {
                l.reset();
              }),
              e("body").on("click", "#showall", function () {
                l.showall();
              }),
              e.isFunction(n.cancelNode) &&
                ((i = e(n.cancelNode.call(l)).hide()),
                u.after(i),
                u.parents(".form-group").addClass("has-feedback"),
                u.prev().is(".control-label") || i.css({ top: 0 }),
              ...
              u.on(
                ...
                ((r = function (t) {
                  if (9 !== t.keyCode) {
                    ...
                    var s = d.filter(function () {
                        return n.itemFilter.call(l, this, r);
                      }),
                      a = d.not(s);
                    (n.itemChild &&
                      ((s = s.parents(n.itemEl)),
                      (a = a.parents(n.itemEl).hide())),
                      "" !== r && r.length >= n.minLength
                        ? (c.html(""),
                          s.show(),
                          a.hide(),
                          i.show(),
                          l.trigger(n.showEvent),
                          "function" === e.type(n.sourceData)
                            ? (s.hide(),
                              a.hide(),
                              o &&
                                (e.isFunction(o.abort)
                                  ? o.abort()
                                  : e.isFunction(o.stop) && o.stop()),
                              c.addClass(n.loadingClass),
                              (o = n.sourceData.call(l, r, function (t) {
                                if (
                                  ((o = null),
                                  s.hide(),
                                  a.hide(),
                                  ...
                                  n.sourceNodes.call(l, n, r, t, function (t) {
                                    e(t).addClass(n.itemClassTmp).appendTo(c);
                                  });
                                else if (t && 0 !== t.length)
                                  if (
                                    n.maxResults < 0 ||
                                    t.length <= n.maxResults
                                  )
                                    for (var i in t)
                                      e(n.sourceNode.call(l, t[i]))
                                        .addClass(n.itemClassTmp)
                                        .appendTo(c);
                                  else
                                    e(n.maxResultsNode(t))
                                      .addClass(n.itemClassTmp)
                                      .appendTo(c);
                                else
                                  e(n.emptyNode.call(l, r))
                                    .addClass(n.itemClassTmp)
                                    .appendTo(c);
                ...
                function () {
                  ...
                  (clearTimeout(a),
                    (a = setTimeout(function () {
                      r.apply(e, Array.prototype.slice.call(t));
                    }, s)));
                }),
              ),
              n.resetOnBlur &&
        ...
        92891: (e, t, n) => {
          ...
          var i = n(33491),
            ...
            d = n(9763),
            f = n(97769),
            p = (n(70123), n(59853), n(47584));
          o.$W.autoReplaceSvg = "nest";
          var h = new i.A();
          (o.Yv.add(r.jk, s.hp, l.vm, d.GR, c.zp, u.SG, a.$U),
            o.tT.watch(),
            (window.jQuery = f),
            (window.$ = f),
            n(52890),
          ...
          f(document).ready(function () {
            var e = null,
              ...
              i = null,
              o = null;
            (n.has("entityID") && (i = n.get("entityID")),
              n.has("trustProfile") && (o = n.get("trustProfile")),
              ...
              f("#ds-search-list")
                ...
                .on("hide.bs", function (t) {
                  (f("#searching").addClass("d-none"), e && clearTimeout(e));
                }),
              f("#add_button").on("click", function (e) {
                (e.preventDefault(),
                  f("#choose").toggleClass("d-none"),
                  f("#search").toggleClass("d-none"));
              }),
              f("#edit_button").on("click", function (e) {
              ...
              f("#done_button").on("click", function (e) {
                (e.preventDefault(),
                  f("#done_button")
                    .toggleClass("d-none")
                    .toggleClass("display-block"),
              ...
              f("#warning-done-button").on("click", function (e) {
                (e.preventDefault(),
              ...
              f("#dsclient")
                .discovery_client({
                  mdq: v,
                  persistence: "${BASE_URL}ps/",
                  search: "${SEARCH_URL}",
                  entityID: i,
                  trustProfile: o,
                  context: "${DEFAULT_CONTEXT}",
                  inputfieldselector: "#searchinput",
                  _render_search_result: function (e, t, n) {
                    var i = h.locale;
                    i = i.split("-")[0];
                    var o = [],
                      r = ejs.compile(
                    ...
                    (e.forEach(function (e) {
                      ...
                      e &&
                        e.length > 0 &&
                        (e[0].hasOwnProperty("counter") && e[0].counter > 1
                          ? f("#ds-search-list").append(o)
                          : f("#ds-search-list").html(o)));
                  },
                  render_search_result: function (t) {
                    var n = this;
                      ...
                      (0, p.F1)(i, v)
                        .then(function (e) {
                          ...
                          (o &&
                            "tinfo" in e &&
                            "profiles" in e.tinfo &&
                            o in e.tinfo.profiles &&
                            (i = e.tinfo.profiles[o].strict),
                            n._render_search_result(t, i, e));
                        })
                        .catch(function (e) {
                          n._render_search_result(t, !0, null);
                        });
                    } catch (e) {
                      n._render_search_result(t, !0, null);
                    }
                  },
                  _render_saved_choice: function (e, t, n) {
                    var i = h.locale;
                    i = i.split("-")[0];
                    var o = !1,
                      r = ejs.compile(
                    ...
                    if (
                      (e.forEach(function (e) {
                        ...
                        var l = {
                            ...
                            strictProfile: t,
                            hint: n,
                            entity_icon_url: e.entity_icon_url,
                          },
                          c = r(l);
                      ...
                      n.title_langs &&
                        n.title_langs[i] &&
                        (s = n.title_langs[i]);
                      var a = h.translateString("filter-warning-no-access"),
                        l = h.translateString(
                          "filter-warning-choose-alternative",
                        ),
                        c = h.translateString("filter-warning-other-options"),
                        u = ejs.render(
                  ...
                  render_saved_choice: function (t) {
                    var n = this;
                    (f("#searching").addClass("d-none"),
                      e && (clearTimeout(e), (e = null)),
                      i &&
                        (0, p.F1)(i, v)
                          .then(function (e) {
                            ...
                            (o &&
                              ...
                              o in e.tinfo.profiles &&
                              (i = e.tinfo.profiles[o].strict),
                              n._render_saved_choice(t, i, e));
                          })
                          .catch(function (e) {
                            n._render_saved_choice(t, !0, null);
                          }));
                  },
                  too_many_results: function (t, n) {
                    (f("#searching").addClass("d-none"),
                    ...
                    var i = ejs.render(
                      ...
                      {
                        count: n,
                        matchesString: h.translateString(
                          "ds-too-many-result-matches",
                        ),
                        keepTypingString: h.translateString(
                          "ds-too-many-result-keep-typing",
                        ),
                        showAnywayString: h.translateString(
                  ...
                  before: function (e) {
                    ...
                    return Promise.all(
                      e.map(function (e) {
                        return (0, p.RT)(
                          encodeURIComponent(e.entity.id),
                          o,
                          i,
                          n.mdq,
                        )
                          ...
                          .catch(function (e) {
                            console.log("Error refreshing entity: ".concat(e));
                          });
                      }),
                    )
                      .then(function (e) {
                        return e.filter(function (e) {
                          return e && void 0 !== e.entity;
                        });
                      })
                      .catch(function (e) {
                        console.log("Error filtering entities: ".concat(e));
                      });
                  },
                  after: function (e, t) {
                    (f("#searching").addClass("d-none"),
                ...
                .discovery_client("sp")
                .then(function (e) {
                  (f(".sp_title").text(e.title),
                    f("#discovery-response-warning-site").text(e.title));
                  var t = !0;
                  if (e.discovery_responses) {
                    var n = window.location.search,
                      i = new URLSearchParams(n),
                      o = null;
                    (i.has("return") && (o = i.get("return")),
                      e.discovery_responses.forEach(function (e) {
                        null !== o && o.startsWith(e) && (t = !0);
                      }));
                  }
                  !1 === t &&
    ...
    var o = i.O(void 0, [990, 769, 775, 918], () => i(92891));
    return i.O(o);
  })(),
);

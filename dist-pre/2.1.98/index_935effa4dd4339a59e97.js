  ...
  (() => {
    var n,
      t = {
              ...
              i.DiscoveryComponent.render(
                {
                  loginHandlerURL:
                    ...
                    "ds/?entityID="
                      .concat(
                        encodeURIComponent(
                          "https://demo.beta.seamlessaccess.org/shibboleth",
                        ),
                        "&return=",
                      )
                      .concat(
                        encodeURIComponent(
                          "https://demo.beta.seamlessaccess.org/Shibboleth.sso/Login",
                        ),
                      ),
                  discoveryResponse: "".concat("${BASE_URL}", "result"),
        ...
        31678: (n, t, e) => {
          ((n.exports = e(47252)), (n.exports.default = n.exports));
        },
        79300: (n, t, e) => {
          "use strict";
          e.d(t, { DiscoveryComponent: () => a });
          var i = e(74119),
            o = e(49880);
          function r(n) {
            (void 0 === n.props.color && (n.props.color = "#216e93"),
              void 0 === n.props.backgroundColor &&
                (n.props.backgroundColor = "#FFFFFF"),
              void 0 === n.dimensions.width && (n.dimensions.width = "350px"),
              void 0 === n.dimensions.height && (n.dimensions.height = "85px"),
              (n.props.dimensions = n.dimensions));
          }
          var a = i.create({
            tag: "thiss-cta",
            url: "${BASE_URL}cta/",
            ...
            containerTemplate: function (n) {
              (r(n),
                n.frame.setAttribute("title", "SeamlessAccess Button"),
                n.frame.setAttribute("aria-label", "SeamlessAccess Button"),
                n.frame.setAttribute("role", "presentation"));
              var t = n.uid,
                e = n.doc,
                i = n.props,
                a = n.dimensions.height,
                s = n.dimensions.width,
                c = n.frame,
                l = n.prerenderFrame,
                d = n.event,
              ...
              return (
                i.cspNonce && u.setAttribute("nonce", i.cspNonce),
                u.appendChild(
                  e.createTextNode(
                    "\n        #"
                      .concat(
            ...
            prerenderTemplate: function (n) {
              var t = n.props.loginInitiatorURL || n.props.loginHandlerURL,
                i = n.props.discoveryRequest,
                o = n.props.discoveryResponse,
                a = n.props.entityID,
                s = n.props.trustProfile;
              if (
                (i || (i = t), o || (o = t), i !== o && "string" == typeof i)
              ) {
                var c = "return=".concat(encodeURIComponent(o));
                (a &&
                  (c = ""
                    .concat(c, "&entityID=")
                    .concat(encodeURIComponent(a))),
                  a && s && (c = "".concat(c, "&trustProfile=").concat(s)),
                  (i =
              ...
              r(n);
              var d = n.doc.createElement("html"),
                p = n.props;
              ...
              var u = d.querySelector("#fallbacklink");
              return (
                null === u && (u = d),
    ...
    ((i.m = t),
      ...
      (i.O = (t, e, o, r) => {
        if (!e) {
          ...
          for (d = 0; d < n.length; d++) {
            for (var [e, o, r] = n[d], s = !0, c = 0; c < e.length; c++)
              (!1 & r || a >= r) && Object.keys(i.O).every((n) => i.O[n](e[c]))
                ? e.splice(c--, 1)
                : ((s = !1), r < a && (a = r));
            if (s) {
              n.splice(d--, 1);
        ...
        r = r || 0;
        for (var d = n.length; d > 0 && n[d - 1][2] > r; d--) n[d] = n[d - 1];
        n[d] = [e, o, r];
      }),
      (i.d = (n, t) => {
        for (var e in t)
      ...
      (i.nmd = (n) => ((n.paths = []), n.children || (n.children = []), n)),
      (() => {
        var n = { 57: 0, 604: 0 };
        i.O.j = (t) => 0 === n[t];
        var t = (t, e) => {
            ...
            for (t && t(e); l < a.length; l++)
              ((r = a[l]), i.o(n, r) && n[r] && n[r][0](), (n[r] = 0));
            return i.O(d);
          },
          e = (this.webpackChunk_theidentityselector_thiss =
            this.webpackChunk_theidentityselector_thiss || []);
        (e.forEach(t.bind(null, 0)), (e.push = t.bind(null, e.push.bind(e))));
      })());
    var o = i.O(void 0, [252, 880, 604], () => i(21519));
    return i.O(o);
  })(),
);

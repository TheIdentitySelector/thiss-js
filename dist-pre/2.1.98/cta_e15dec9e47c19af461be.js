/*! For license information please see cta_e15dec9e47c19af461be.js.LICENSE.txt */
!(function (t, e) {
  ...
  (() => {
    ...
    var t,
      ...
      a = {
        ...
        33491: (t, e, n) => {
          ...
          function i() {
            ...
            var g = [][r]
                ...
                : (a((e = {}), r, function () {
                  ...
                  e),
              p = (f.prototype = u.prototype = Object.create(g));
            function y(t) {
              return (
                Object.setPrototypeOf
                  ? Object.setPrototypeOf(t, f)
                  : ((t.__proto__ = f), a(t, o, "GeneratorFunction")),
          ...
          var d = n(87860),
            h = "en",
            m = document.getElementById("locale-selector"),
            w = (function (t) {
              function e(t) {
                var n;
                return (
                      ...
                      return new Promise(function (n, r) {
                        fetch("/translations/".concat(t, ".json"))
                          ...
                          .then(function (r) {
                            if (t in e.dynamic)
                              for (
                                var o = 0, i = Object.keys(e.dynamic[t]);
                                o < i.length;
                                o++
                              ) {
                                var a = i[o];
                            ...
                            for (
                              var c = document.querySelectorAll("[data-i18n]"),
                                s = 0;
                              s < c.length;
                              s++
                            ) {
                              var u = c[s].dataset.i18n;
                              if (u) {
                                var l = e.i18n(u);
                                l && l !== u && (c[s].textContent = l);
                              }
                            }
                            n();
                          })
                            ...
                            for (;;)
                              switch (t.n) {
                                case 0:
                                  ...
                                  ((n = this.translateString(e)), (t.n = 9));
                                  break;
                                case 1:
                                  ((r = !1),
                                    (a = c(new Array(60).keys())),
                                    (t.p = 2),
                                    (u = i().m(function t() {
          ...
          r.a(t, async (t, o) => {
            try {
              ...
              var i = r(36423),
                ...
                u = r(37457),
                l = (r(79300), r(33491)),
                f = (r(14029), r(24365), t([s]));
              s = (f.then ? (await f)() : f)[0];
              var g = r(31678);
              (i.Yv.add(a.hp), i.tT.watch());
              var p = window.location.search,
                ...
                w = null,
                M =
                  window.xprops.loginInitiatorURL ||
                  window.xprops.loginHandlerURL,
                I = window.xprops.discoveryRequest,
                v = window.xprops.discoveryResponse,
                A = null,
                N = new l.A(window.xprops.locale);
              (I || (I = M),
                v || (v = M),
                window.xprops.entityID && (m = window.xprops.entityID),
                window.xprops.trustProfile && (w = window.xprops.trustProfile),
                window.xprops.persistenceURL &&
                  (d = window.xprops.persistenceURL),
                window.xprops.context && (h = window.xprops.context),
                window.xprops.MDQ && (y = window.xprops.MDQ));
              var b = new URL(d).hostname,
                j = window.location.hostname,
                T = !0;
              if ((b !== j && (T = !1), I !== v && "string" == typeof I)) {
                var x = "return=".concat(encodeURIComponent(v));
                (m &&
                  (x = ""
                    .concat(x, "&entityID=")
                    .concat(encodeURIComponent(m))),
                  m && w && (x = "".concat(x, "&trustProfile=").concat(w)),
                  (I =
                    new URL(I).searchParams.size > 0
                      ? "".concat(I, "&").concat(x)
                      : "".concat(I, "?").concat(x)));
              }
              ...
              if ("function" != typeof v) {
                ...
                v = function (t) {
                  var e = { return: C };
                  return (window.top.location.href = (0, c.Ky)(t, e));
                };
              }
              var D = new c.KC(y, d, h, { entityID: m, trustProfile: w });
              g.on("initialized", { window: D.ps.dst }, function (t) {
                !(function (t, e) {
                  Promise.all(t).then(function () {
                    D.ps
                      ...
                      .then(function (t) {
                        var e = t.reverse().map(function (t) {
                          return (0, c.Tj)(
                            "{sha1}".concat((0, u.A)(t.entity.entityID)),
                            w,
                            m,
                            y,
                          );
                            ...
                            if (!n && "fulfilled" === t.status) {
                              ...
                              ("title_langs" in r &&
                                ...
                                (document.getElementById("title").innerText =
                                  o),
                                (A = r.entity_id || r.entityID),
                                N.translateStringP("cta-button-header").then(
                                  function (t) {
                                ...
                                (document.getElementById("dsbutton").hidden =
                                  !1));
                            }
                          }),
                            n ||
                              N.translateStringP("cta-button-placeholder").then(
                                function (t) {
                                  document.getElementById("title").innerText =
                                    t;
                                },
              ...
              var L = [];
              function O() {
                var t = document.getElementById("idpbutton"),
                  n = document.getElementById("dsbutton");
                ((document.getElementById("main").style.background =
                  window.xprops.backgroundColor),
                  (t.style.background = window.xprops.color),
                  (t.style.boxShadow = "0 0 0 5px " + window.xprops.color),
                  (n.style.color = window.xprops.color));
                var r = !1,
                  o = function () {
                    t.style.boxShadow =
                      "0 0 0 1px, 0 0 0 4px " + window.xprops.color;
                  },
                  i = function () {
                    t.style.boxShadow = "0 0 0 5px " + window.xprops.color;
                  };
                (t.addEventListener("focus", function (t) {
                  ...
                  t.addEventListener("click", function (t) {
                    null !== A
                      ? D.do_saml_discovery_response(A).then(function (t) {
                          v(t.entity);
                        })
                      : T
                        ? (0, s.d4)(I)
                  ...
                  n.addEventListener("click", function (t) {
                    (t.preventDefault(), T ? (0, s.d4)(I) : I());
                  }),
                  n.addEventListener("keypress", function (t) {
                    "Enter" === e.key && n.click();
                  }),
                  D.ps.expire || (D.ps.expire = function () {}));
              }
              (window.xprops.pinned && L.push(D.pin(window.xprops.pinned)),
        ...
        79300: (t, e, n) => {
          var r = n(74119),
            o = n(49880);
          function i(t) {
            (void 0 === t.props.color && (t.props.color = "#216e93"),
              void 0 === t.props.backgroundColor &&
                (t.props.backgroundColor = "#FFFFFF"),
              void 0 === t.dimensions.width && (t.dimensions.width = "350px"),
              void 0 === t.dimensions.height && (t.dimensions.height = "85px"),
              (t.props.dimensions = t.dimensions));
          }
          var a = r.create({
            tag: "thiss-cta",
            url: "${COMPONENT_URL}",
            ...
            color: "#0079ff",
            locale: null,
            containerTemplate: function (t) {
              (i(t),
                t.frame.setAttribute("title", "SeamlessAccess Button"),
                t.frame.setAttribute("aria-label", "SeamlessAccess Button"),
                t.frame.setAttribute("role", "presentation"));
              var e = t.uid,
                n = t.doc,
                r = t.props,
              ...
              f.setAttribute("id", e);
              var g = n.createElement("style");
              return (
                r.cspNonce && g.setAttribute("nonce", r.cspNonce),
                g.appendChild(
                  n.createTextNode(
                    "\n        #"
                      .concat(
            ...
            prerenderTemplate: function (t) {
              var e = t.props.loginInitiatorURL || t.props.loginHandlerURL,
                r = t.props.discoveryRequest,
                o = t.props.discoveryResponse,
                a = t.props.entityID,
                c = t.props.trustProfile;
              if (
                (r || (r = e), o || (o = e), r !== o && "string" == typeof r)
              ) {
                var s = "return=".concat(encodeURIComponent(o));
                (a &&
                  (s = ""
                    .concat(s, "&entityID=")
                    .concat(encodeURIComponent(a))),
                  a && c && (s = "".concat(s, "&trustProfile=").concat(c)),
                  (r =
              ...
              i(t);
              var l = t.doc.createElement("html"),
                f = t.props;
              ...
              var g = l.querySelector("#fallbacklink");
              return (
                null === g && (g = l),
          ...
          n.a(
            ...
            async (t, r) => {
              try {
                  ...
                  function g(t) {
                    return (
                      Object.setPrototypeOf
                        ...
                        : ((t.__proto__ = u), d(t, o, "GeneratorFunction")),
                ...
                var a = ["chrome", "chromium", "edge", "edge-chromium"];
                try {
                  var c = JSON.parse(
                    '${SAA_COMPLIANT_BROWSERS}',
                  );
                  if (!Array.isArray(c))
                    throw new Error(
                      "SAA COMPLIANT is not an array: ".concat(c),
                    );
                  a = a.concat(c);
                } catch (z) {
                  console.log(
                            ...
                            switch (t.n) {
                              case 0:
                                if (
                                  ...
                                  (I = function (t) {
                                    ...
                                    var n = {
                                      localStorage: N({}, l.localStorage, {
                                        _ns: t,
                                      }),
                                      sessionStorage: N({}, l.sessionStorage, {
                                        _ns: t,
                                      }),
                                    };
                                    return (
                                  ...
                                  (w = function () {
                                    ...
                                    if (Array.isArray(r)) {
                                      for (t = 0; t < r.length; t++)
                                        if (!w.call(this, r[t])) return !1;
                                      return !0;
                                    }
                                    try {
                                      var o = f.apply(this, arguments);
                                      for (t in (Array.isArray(n[e - 1]) ||
                                        (o = { totest: o }),
                                      o))
                                        if (
                                          o.hasOwnProperty(t) &&
                                  ...
                                  (m = function () {
                                    var t,
                                      ...
                                      n = arguments,
                                      r = n[0];
                                    if (0 == e) return 0 == M.call(this).length;
                                    if (Array.isArray(r)) {
                                      for (t = 0; t < r.length; t++)
                                        if (!m.call(this, r[t])) return !1;
                                      return !0;
                                    }
                                    try {
                                      var o = f.apply(this, arguments);
                                  ...
                                  (d = function (t) {
                                    var e,
                                      n = M.call(this);
                                    for (e in n)
                                      n.hasOwnProperty(e) && p.call(this, n[e]);
                                    if (t)
                                      for (e in l.namespaceStorages)
                                        l.namespaceStorages.hasOwnProperty(e) &&
                                          I(e);
                                  }),
                                  (p = function () {
                                    var t,
                                  ...
                                  (f = function () {
                                    ...
                                    if (1 != c) {
                                      try {
                                        n = JSON.parse(s.getItem(l));
                                      } catch (t) {
                                        throw new ReferenceError(
                                          l + " is not defined in this storage",
                                        );
                                      }
                                      for (o = 1; o < c - 1; o++)
                                        if (void 0 === (n = n[u[o]]))
                              ...
                              case 4:
                                return (
                                  (n = t.v),
                                  (i = (r = {}).toString),
                                  (c = (a = r.hasOwnProperty).toString),
                                  (s = c.call(Object)),
                                  (u = Object.getPrototypeOf),
                                  (j = !1),
                                  ((l = {}).storage_available = b = !0),
                                  (l.cookies_available = j),
                                  (T = {
                                    _type: "",
                                    _ns: "",
                                    _callMethod: function (t, e) {
                                      ...
                                      return (
                                        this._ns && n.push(this._ns),
                                        "string" == typeof r &&
                                          -1 !== r.indexOf(".") &&
                                          (e.shift(),
                                          [].unshift.apply(e, r.split("."))),
                                        [].push.apply(n, e),
                                        t.apply(this, n)
                                      );
                                    },
                                    ...
                                    set: function () {
                                      ...
                                      if (v(n) && this._ns) {
                                        for (var r in n)
                                          n.hasOwnProperty(r) &&
                                            this._callMethod(g, [r, n[r]]);
                                        return n;
                                      }
                                      var o = this._callMethod(g, e);
                                      return this._ns ? o[n.split(".")[0]] : o;
                                    },
                                    remove: function () {
                                      ...
                                      return b || j
                                        ? this._callMethod(p, arguments)
                                        : null;
                                    },
                                    removeAll: function (t) {
                                      return b || j
                                        ? this._ns
                                          ? (this._callMethod(g, [{}]), !0)
                                          : this._callMethod(d, [t])
                                        : null;
                                    },
                                    isEmpty: function () {
                                      return b || j
                                  ...
                                  j &&
                                    ...
                                    b ||
                                      ((e.localCookieStorage = N({}, S, {
                                        _prefix: "ls_",
                                        _expires: 3650,
                                      })),
                                      (e.sessionCookieStorage = N({}, S, {
                                        _prefix: "ss_" + x + "_",
                                      }))),
                                    (e.cookieStorage = N({}, S)),
                                    (l.cookieStorage = N({}, T, {
                                      ...
                                      setExpires: function (t) {
                                        return (
                                          e.cookieStorage.setExpires(t),
                                          this
                                        );
                                      },
                                      setPath: function (t) {
                                        return (
                                          e.cookieStorage.setPath(t),
                                          this
                                        );
                                      },
                                      setDomain: function (t) {
                                        return (
                                          e.cookieStorage.setDomain(t),
                                          this
                                        );
                                      },
                                      setConf: function (t) {
                                        return (
                                          e.cookieStorage.setConf(t),
                                          this
                                        );
                                      },
                                      setDefaultConf: function () {
                                        return (
                                          e.cookieStorage.setDefaultConf(),
                                          this
                                        );
                                      },
                                    }))),
                                  (l.initNamespaceStorage = function (t) {
                                    return I(t);
                                  }),
                                  b
                                    ? ((l.localStorage = N({}, T, {
                                  ...
                                  (l.namespaceStorages = {}),
                                  (l.removeAllStorages = function (t) {
                                    (l.localStorage.removeAll(t),
                                      l.sessionStorage.removeAll(t),
                                      l.cookieStorage &&
                                        l.cookieStorage.removeAll(t),
                                      t || (l.namespaceStorages = {}));
                                  }),
                                  (l.alwaysUseJsonInStorage = function (t) {
                                    ((T.alwaysUseJson = t),
                                      (l.localStorage.alwaysUseJson = t),
                                      (l.sessionStorage.alwaysUseJson = t),
                                      l.cookieStorage &&
                                        (l.cookieStorage.alwaysUseJson = t));
                                  }),
                                  t.a(2, l)
                                );
                            }
                ...
                function b(t, e) {
                  ...
                  (null != e.entity
                    ? (e = (n = e).entity)
                    : (n = { last_refresh: r, last_use: r, entity: e }),
                    e.entityID && !e.entity_id && (e.entity_id = e.entityID));
                  var o = e.entity_id.hexEncode();
                  return ((n = v(n)), t.set(o, n));
                }
                ...
                function T(t) {
                  t || (t = "${DEFAULT_CONTEXT}");
                  var e = u.initNamespaceStorage(t).localStorage;
                  return (e.set("_name", t), e);
                }
                function x(t, e) {
                      ...
                      return y().w(
                        function (t) {
                          for (;;)
                            switch (t.n) {
                              case 0:
                                ((n = T((e = e || "${DEFAULT_CONTEXT}"))),
                                  (r = n.keys().filter(function (t) {
                          ...
                          for (;;)
                            switch (t.n) {
                              ...
                              case 1:
                                ...
                                return t.a(2, window);
                              case 2:
                                return ((t.n = 3), document.hasStorageAccess());
                              case 3:
                                if (!t.v) {
                                  t.n = 6;
                                  break;
                              ...
                              case 13:
                                ...
                                break;
                              case 14:
                                return ((t.p = 14), t.v, t.a(2, window));
                              case 15:
                                t.n = 18;
                                break;
                              case 16:
                          ...
                          for (;;)
                            switch (t.n) {
                              case 0:
                                ...
                                return t.a(2, !0);
                              case 1:
                                return ((t.n = 2), document.hasStorageAccess());
                              case 2:
                                if (!t.v) {
                                  t.n = 3;
                                  break;
    ...
    function s(t) {
      ...
      var n = (c[t] = { id: t, loaded: !1, exports: {} });
      return (
        a[t].call(n.exports, n, n.exports, s),
        (n.loaded = !0),
        n.exports
      );
    }
      ...
      (s.O = (t, e, n, r) => {
        if (!e) {
          ...
          for (l = 0; l < i.length; l++) {
            for (var [e, n, r] = i[l], a = !0, c = 0; c < e.length; c++)
              (!1 & r || o >= r) && Object.keys(s.O).every((t) => s.O[t](e[c]))
                ? e.splice(c--, 1)
                : ((a = !1), r < o && (o = r));
            if (a) {
              i.splice(l--, 1);
        ...
        r = r || 0;
        for (var l = i.length; l > 0 && i[l - 1][2] > r; l--) i[l] = i[l - 1];
        i[l] = [e, n, r];
      }),
      (s.n = (t) => {
    ...
    var u = s.O(void 0, [990, 252, 880, 775, 925], () => s(56549));
    return s.O(u);
  })(),
);

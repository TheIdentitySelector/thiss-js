/*! For license information please see cta_7b8c5898ebf8f92c611a.js.LICENSE.txt */
!(function (t, e) {
  ...
  (() => {
        ...
        33491: (t, e, n) => {
          ...
          function o() {
            ...
            var b = Object.getPrototypeOf,
              N = b && b(b(k([])));
            N && N !== n && i.call(N, s) && (x = N);
            var A = (I.prototype = v.prototype = Object.create(x));
            function L(t) {
            ...
            function T(e, n, r) {
              ...
              return function (i, a) {
                ...
                for (r.method = i, r.arg = a; ; ) {
                  ...
                  var u = p(e, n, r);
                  if ("normal" === u.type) {
                    if (((o = r.done ? m : g), u.arg === w)) continue;
            ...
            return (
              (M.prototype = I),
              a(A, "constructor", { value: I, configurable: !0 }),
              a(I, "constructor", { value: M, configurable: !0 }),
              (M.displayName = f(I, l, "GeneratorFunction")),
              ...
              (e.mark = function (t) {
                return (
                  Object.setPrototypeOf
                    ...
                    : ((t.__proto__ = I), f(t, l, "GeneratorFunction")),
              ...
              (E.prototype = {
                ...
                finish: function (t) {
                  for (var e = this.tryEntries.length - 1; e >= 0; --e) {
                    ...
                    if (n.finallyLoc === t)
                      return this.complete(n.completion, n.afterLoc), D(n), w;
                  }
                },
                catch: function (t) {
                  for (var e = this.tryEntries.length - 1; e >= 0; --e) {
          ...
          r.a(t, async (t, o) => {
            try {
              ...
              var p = window.location.search,
                ...
                M = window.xprops.discoveryRequest,
                I = window.xprops.discoveryResponse,
                x = null,
                b = new l.A(window.xprops.locale);
              M || (M = v),
                I || (I = v),
                ...
                window.xprops.persistenceURL &&
                  (g = window.xprops.persistenceURL),
                window.xprops.context && (d = window.xprops.context),
                window.xprops.MDQ && (y = window.xprops.MDQ);
              var N = new URL(g).hostname,
                A = window.location.hostname,
                L = !0;
              if ((N !== A && (L = !1), M !== I && "string" == typeof M)) {
                var j = "return=".concat(encodeURIComponent(I));
                m &&
                  (j = ""
                    .concat(j, "&entityID=")
                    .concat(encodeURIComponent(m))),
                  m && w && (j = "".concat(j, "&trustProfile=").concat(w)),
                  (M =
                    new URL(M).searchParams.size > 0
                      ? "".concat(M, "&").concat(j)
                      : "".concat(M, "?").concat(j));
              }
              ...
              var C = new c.KC(y, g, d, { entityID: m, trustProfile: w });
              h.on("initialized", { window: C.ps.dst }, function (t) {
                !(function (t, e) {
                  Promise.all(t).then(function () {
                    C.ps
                      ...
                      .then(function (t) {
                        ...
                        Promise.allSettled(e).then(function (t) {
                          ...
                          t.forEach(function (t) {
                            if (!n && "fulfilled" === t.status) {
                              ...
                              "title_langs" in r &&
                                ...
                                (document.getElementById("title").innerText =
                                  o),
                                (x = r.entity_id || r.entityID),
                                b
                                  .translateStringP("cta-button-header")
                                  .then(function (t) {
                            ...
                            n ||
                              b
                                .translateStringP("cta-button-placeholder")
                                .then(function (t) {
                                  document.getElementById("title").innerText =
                                    t;
                                });
                      ...
                      .catch(function (t) {
                        b.translateStringP("cta-button-placeholder").then(
                          function (t) {
              ...
              function E() {
                ...
                t.addEventListener("focus", function (t) {
                  ...
                  t.addEventListener("click", function (t) {
                    null !== x
                      ? C.do_saml_discovery_response(x).then(function (t) {
                          I(t.entity);
                        })
                      : L
                        ? (0, s.d4)(M)
                  ...
                  n.addEventListener("click", function (t) {
                    t.preventDefault(), L ? (0, s.d4)(M) : M();
                  }),
                  n.addEventListener("keypress", function (t) {
                    "Enter" === e.key && n.click();
                  }),
                  C.ps.expire || (C.ps.expire = function () {});
              }
              window.xprops.pinned && D.push(C.pin(window.xprops.pinned)),
        ...
        79300: (t, e, n) => {
          ...
          var a = r.create({
            ...
            containerTemplate: function (t) {
              ...
              return (
                r.cspNonce && h.setAttribute("nonce", r.cspNonce),
                h.appendChild(
                  n.createTextNode(
                    "\n        #"
                      .concat(
            ...
            prerenderTemplate: function (t) {
              ...
              var h = l.querySelector("#fallbacklink");
              return (
                null === h && (h = l),
            ...
            async (t, r) => {
              try {
                ...
                function p() {
                  ...
                  return (
                    (M.prototype = I),
                    o(A, "constructor", { value: I, configurable: !0 }),
                    o(I, "constructor", { value: M, configurable: !0 }),
                    (M.displayName = u(I, s, "GeneratorFunction")),
                    (e.isGeneratorFunction = function (t) {
                      var e = "function" == typeof t && t.constructor;
                      return (
                        !!e &&
                    ...
                    (e.mark = function (t) {
                      return (
                        Object.setPrototypeOf
                          ? Object.setPrototypeOf(t, I)
                          : ((t.__proto__ = I), u(t, s, "GeneratorFunction")),
                        (t.prototype = Object.create(A)),
                        t
                      );
                    }),
                    ...
                    (E.prototype = {
                      ...
                      finish: function (t) {
                        for (var e = this.tryEntries.length - 1; e >= 0; --e) {
                          ...
                          if (n.finallyLoc === t)
                            return (
                              this.complete(n.completion, n.afterLoc), D(n), w
                            );
                        }
                      },
                      catch: function (t) {
                            ...
                            switch ((t.prev = t.next)) {
                              case 0:
                                if (
                                  ...
                                  (M = function (t) {
                                    ...
                                    var n = {
                                      localStorage: b({}, l.localStorage, {
                                        _ns: t,
                                      }),
                                      sessionStorage: b({}, l.sessionStorage, {
                                        _ns: t,
                                      }),
                                    };
                                    return (
                                  ...
                                  (m = function () {
                                    var t,
                                      ...
                                      n = arguments,
                                      r = n[0];
                                    if (0 == e) return 0 == v.call(this).length;
                                    if (Array.isArray(r)) {
                                      for (t = 0; t < r.length; t++)
                                  ...
                                  (d = function (t) {
                                    var e,
                                      n = v.call(this);
                                    for (e in n)
                                      n.hasOwnProperty(e) && g.call(this, n[e]);
                                    if (t)
                              ...
                              case 22:
                                return (
                                  ...
                                  (A = !1),
                                  ((l = {}).storage_available = N = !0),
                                  (l.cookies_available = A),
                                  (L = {
                                    _type: "",
                                    _ns: "",
                                    ...
                                    keys: function () {
                                      return N || A
                                        ? this._callMethod(v, arguments)
                                        : null;
                                    },
                                  }),
                                  A &&
                                    ((j = Math.floor(1e8 * Math.random())),
                                    (T = {
                                      _cookie: !0,
                                      _prefix: "",
                                      _expires: null,
                                    ...
                                    N ||
                                      ((e.localCookieStorage = b({}, T, {
                                        _prefix: "ls_",
                                        _expires: 3650,
                                      })),
                                      (e.sessionCookieStorage = b({}, T, {
                                        _prefix: "ss_" + j + "_",
                                      }))),
                                    (e.cookieStorage = b({}, T)),
                                    (l.cookieStorage = b({}, L, {
                          ...
                          for (;;)
                            switch ((t.prev = t.next)) {
                              ...
                              case 7:
                                ...
                                return (c = a.value), (t.next = 11), M(n, c);
                              case 11:
                                (s = t.sent), o.push(v(s));
                              case 13:
                                t.next = 7;
    ...
    function s(t) {
      ...
      return a[t].call(n.exports, n, n.exports, s), (n.loaded = !0), n.exports;
    }
    (s.m = a),
      (t =
        "function" == typeof Symbol
